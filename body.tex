...
\begin{table}[!hbt]
\centering
    \caption{Comparison of Natural Modes, $N=100$, $\alpha=70$\label{table:compare}}
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline 
\textbf{Mode Type} & \textbf{Mode} & $\delta$ & $\gamma$ & \textbf{Present} & \textbf{Ref.~\cite{chung2002dynamic}} & \textbf{Ref.~\cite{wright82vibration}}\\ 
\hline
